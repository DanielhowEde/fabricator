...
function UiRouterProvider({ children }) {
    _s();
    const [activeRoute, setActiveRouteState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "UiRouterProvider.useState": ()=>{
            // Safe in client components, but still guard for robustness
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const saved = window.localStorage.getItem(ROUTE_KEY);
            return saved && saved.trim().length > 0 ? saved : DEFAULT_ROUTE;
        }
    }["UiRouterProvider.useState"]);
    ...
    // Keep the public setter stable
    const setActiveRoute = (r)=>setActiveRouteState(r);
...
_s(UiRouterProvider, "KXmRSqGBMYJkxc0KdZnYxYZO5Gc=");
_c = UiRouterProvider;
...
//# sourceMappingURL=_48552fe5._.js.map